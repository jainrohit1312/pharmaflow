...
half of it. Do **not** re-do purchase screens, and do not start Phase 3.
...
5. Add any new decision to `DECISIONS.md` (the next free id is **D-019**).
...
Start with the inventory repository and its stock-view controller, then the
screens. Run `flutter analyze` after each module and fix everything immediately.
