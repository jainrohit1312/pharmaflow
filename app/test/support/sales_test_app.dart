  ...
  await tester.pumpWidget(
    ProviderScope(
      ...
      overrides: [
        ...
        // The approval rail, for the above-cap discount: the counter asks the owner and
        // then re-reads its own request, so a test that drove neither would be asserting
